...
# Limits can also be called pagination:
...
# calculation for limit and offset: ((desired page number - 1) * limit amount) OR
# (desired page number * limit amount - limit amount)
